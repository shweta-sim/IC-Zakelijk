...
<title>IrisCall Zakelijk | Bijzondere voorwaarden</title>
...
<section class="banner-inner banner-terms hidden-print">
  <div class="banner-inner-text">
    <h2 class="page-title wow fadeInUp" data-wow-delay="100ms">Bijzondere voorwaarden</h2>
    <ul class="breadcrumb wow fadeInUp" data-wow-delay="200ms">
      <li><a href="index.php">Home</a></li>
      <li class="active">Bijzondere voorwaarden</li>
    </ul>
  </div>
</section>
<!-- ########## Banner end ########## --> 
